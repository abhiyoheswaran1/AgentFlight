...
- `history` lists recent local sessions, recorded readiness, and existing handoff/report/replay artifacts without uploading, syncing, or switching sessions.
...
- `agentflight history` lists recent local sessions, current-session marker, proof counts, latest recorded readiness, and existing local handoff/report/replay paths.
