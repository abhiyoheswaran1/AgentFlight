...
- `agentflight history` lists recent local sessions, current-session marker, proof counts, latest recorded readiness, which artifact to open first, and existing local handoff/report/replay/resume paths.
