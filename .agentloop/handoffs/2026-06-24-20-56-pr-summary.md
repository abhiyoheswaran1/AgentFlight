...
- AgentLoop evidence: `15` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/runs/`, `.agentloop/state.json`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
